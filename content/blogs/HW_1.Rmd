...
draft: no
image: 'static\images\blogs\spices.jpg'
keywords: ''
slug: HW_1
categories:
- ''
...
```{r, setup, echo=FALSE, class.source="watch-out"}
...
```{r load-libraries, warning=FALSE, message=FALSE, echo=FALSE, class.source="watch-out", class.output="watch-out"}
...
```{r,load_movies, warning=FALSE, message=FALSE, class.source="watch-out", class.output="watch-out"}
movies <- read_csv(here::here("content/data", "movies.csv"))
glimpse(movies)
skimr::skim(movies)
...
```{r, data inspection, class.source="watch-out", class.output="watch-out"}
...
```{r, gross earnings and budget, class.source="watch-out", class.output="watch-out"}
...
```{r, top directors, class.source="watch-out", class.output="watch-out"}
...
```{r, ratings by genre, class.source="watch-out", class.output="watch-out"}
...
```{r, rating by genre - Histogram, class.source="watch-out", class.output="watch-out"}
...
```{r, facebook likes scatterplot, class.source="watch-out", class.output="watch-out"}
...
```{r, gross_on_budget, class.source="watch-out", class.output="watch-out"}
...
```{r, gross_on_rating, class.source="watch-out", class.output="watch-out"}
